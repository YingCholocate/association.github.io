...
var url = 'https://jxfw.gdut.edu.cn/login!welcome.action'
// 请求头
var headers = {
...
function login() {
    superagent.post('https://jxfw.gdut.edu.cn/new/login')
        .set(headers)
        .set("Cookie", cookie)
        .send(sxau)
        .end(function (err, res) {
...
function getClass() {
    superagent.get("https://jxfw.gdut.edu.cn/xsbjkbcx!getKbRq.action?xnxqdm=202102&zc=5")
        .set(headers1)
        .set("Accept", "*/*")
        .set("Cookie", cookie)
        .end(function (err, res) {
